...
function getData(){
  // Class eq '節慶活動'
  axios.get(`https://ptx.transportdata.tw/MOTC/v2/Tourism/Restaurant?%24filter=Class%20eq%20'${thisCategory}'&%24format=JSON`, {
...
function getNearbyTourList(){
  ...
  axios.get(`https://ptx.transportdata.tw/MOTC/v2/Tourism/Restaurant?%24spatialFilter=nearby(${latitude}%2C%20${longitude}%2C%203000)&%24format=JSON`,{
    header: getAuthorizationHeader(),
  })
  .then(function (response) {
    console.log(response.data);
