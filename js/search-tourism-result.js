...
function getData(){
  ...
  axios.get(`https://ptx.transportdata.tw/MOTC/v2/Tourism/ScenicSpot?%24filter=Class1%20eq%20'${thisCategory}'%20or%20Class2%20eq%20'${thisCategory}'%20or%20Class3%20eq%20'${thisCategory}'&%24format=JSON`, {
...
send.addEventListener("click", function(e){
  ...
  if(categolyEN == "allCity" && themeEN == "allTheme"){
    axios.get(`https://ptx.transportdata.tw/MOTC/v2/Tourism/ScenicSpot?%24filter=contains(ScenicSpotName%2C%20'${keyword}')&%24format=JSON`, {
      headers: getAuthorizationHeader()
    })
    .then (function(response){
    ...
    axios.get(`https://ptx.transportdata.tw/MOTC/v2/Tourism/ScenicSpot?%24filter=contains(ScenicSpotName%2C%20'${keyword}')%20and%20(Class1%20eq%20'${themeEN}'%20or%20Class2%20eq%20'${themeEN}'%20or%20Class3%20eq%20'${themeEN}')&%24format=JSON`, {
      headers: getAuthorizationHeader()
    })
    .then (function(response){
      console.log(response.data);
    ...
    axios.get(`https://ptx.transportdata.tw/MOTC/v2/Tourism/ScenicSpot/${categolyEN}?%24filter=contains(ScenicSpotName%2C%20'${keyword}')&%24format=JSON`, {
      headers: getAuthorizationHeader()
    })
    .then (function(response){
      console.log(response.data);
    ...
    // %2C代表逗號, %20代表空格
    axios.get(`https://ptx.transportdata.tw/MOTC/v2/Tourism/ScenicSpot/${categolyEN}?%24filter=contains(ScenicSpotName%2C%20'${keyword}')%20and%20(Class1%20eq%20'${themeEN}'%20or%20Class2%20eq%20'${themeEN}'%20or%20Class3%20eq%20'${themeEN}')&%24format=JSON`, {
      headers: getAuthorizationHeader()
    })
    .then (function(response){
      // console.log(response.data);
...
function getNearbyTourList(){
  ...
  axios.get(`https://ptx.transportdata.tw/MOTC/v2/Tourism/ScenicSpot?%24spatialFilter=nearby(${latitude}%2C%20${longitude}%2C%205000)&%24format=JSON`,{
    header: getAuthorizationHeader(),
  })
  .then(function (response) {
    console.log(response.data);
